...
func (c *rPCClient) CreateBuildConfig(ctx context.Context, in *CreateBuildConfigRequest, opts ...grpc.CallOption) (*BuildConfig, error) {
	...
	out := new(BuildConfig)
	err := c.cc.Invoke(ctx, RPC_CreateBuildConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) QueryBuildConfig(ctx context.Context, in *QueryBuildConfigRequest, opts ...grpc.CallOption) (*BuildConfigSet, error) {
	...
	err := c.cc.Invoke(ctx, RPC_QueryBuildConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) DescribeBuildConfig(ctx context.Context, in *DescribeBuildConfigRequst, opts ...grpc.CallOption) (*BuildConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BuildConfig)
	err := c.cc.Invoke(ctx, RPC_DescribeBuildConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) UpdateBuildConfig(ctx context.Context, in *UpdateBuildConfigRequest, opts ...grpc.CallOption) (*BuildConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BuildConfig)
	err := c.cc.Invoke(ctx, RPC_UpdateBuildConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) DeleteBuildConfig(ctx context.Context, in *DeleteBuildConfigRequest, opts ...grpc.CallOption) (*BuildConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BuildConfig)
	err := c.cc.Invoke(ctx, RPC_DeleteBuildConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
