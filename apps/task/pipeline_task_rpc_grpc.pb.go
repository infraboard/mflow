...
func (c *pipelineRPCClient) RunPipeline(ctx context.Context, in *pipeline.RunPipelineRequest, opts ...grpc.CallOption) (*PipelineTask, error) {
	...
	err := c.cc.Invoke(ctx, PipelineRPC_RunPipeline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineRPCClient) QueryPipelineTask(ctx context.Context, in *QueryPipelineTaskRequest, opts ...grpc.CallOption) (*PipelineTaskSet, error) {
	...
	err := c.cc.Invoke(ctx, PipelineRPC_QueryPipelineTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineRPCClient) DescribePipelineTask(ctx context.Context, in *DescribePipelineTaskRequest, opts ...grpc.CallOption) (*PipelineTask, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PipelineTask)
	err := c.cc.Invoke(ctx, PipelineRPC_DescribePipelineTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineRPCClient) DeletePipelineTask(ctx context.Context, in *DeletePipelineTaskRequest, opts ...grpc.CallOption) (*PipelineTask, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PipelineTask)
	err := c.cc.Invoke(ctx, PipelineRPC_DeletePipelineTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPipelineRPCServer must be embedded to have
...
func (UnimplementedPipelineRPCServer) testEmbeddedByValue()                     {}
...
func RegisterPipelineRPCServer(s grpc.ServiceRegistrar, srv PipelineRPCServer) {
	// If the following call pancis, it indicates UnimplementedPipelineRPCServer was
