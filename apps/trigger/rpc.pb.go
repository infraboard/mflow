...
var file_mflow_apps_trigger_pb_rpc_proto_goTypes = []interface{}{
	...
	(*Event)(nil),                         // 3: infraboard.mflow.trigger.Event
	(*Record)(nil),                        // 4: infraboard.mflow.trigger.Record
	(*RecordSet)(nil),                     // 5: infraboard.mflow.trigger.RecordSet
}
var file_mflow_apps_trigger_pb_rpc_proto_depIdxs = []int32{
	...
	3, // 1: infraboard.mflow.trigger.RPC.HandleEvent:input_type -> infraboard.mflow.trigger.Event
	0, // 2: infraboard.mflow.trigger.RPC.QueryRecord:input_type -> infraboard.mflow.trigger.QueryRecordRequest
	4, // 3: infraboard.mflow.trigger.RPC.HandleEvent:output_type -> infraboard.mflow.trigger.Record
	5, // 4: infraboard.mflow.trigger.RPC.QueryRecord:output_type -> infraboard.mflow.trigger.RecordSet
