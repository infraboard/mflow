...
type EventQueueTaskCompleteRequest struct {
	...
	// @gotags: json:"build_conf_id"
	BuildConfId string `protobuf:"bytes,1,opt,name=build_conf_id,json=buildConfId,proto3" json:"build_conf_id"`
	// 是否触发队列里面下一个任务执行
	// @gotags: json:"trigger_next"
	TriggerNext bool `protobuf:"varint,2,opt,name=trigger_next,json=triggerNext,proto3" json:"trigger_next"`
	// 强制触发下一个任务执行, 因为构造状态已经结束的并不运行被重复触发
	// @gotags: json:"force_trigger"
	ForceTrigger bool `protobuf:"varint,3,opt,name=force_trigger,json=forceTrigger,proto3" json:"force_trigger"`
}
...
func (x *EventQueueTaskCompleteRequest) GetTriggerNext() bool {
	if x != nil {
		return x.TriggerNext
	}
	return false
}

func (x *EventQueueTaskCompleteRequest) GetForceTrigger() bool {
	if x != nil {
...
var file_mflow_apps_trigger_pb_rpc_proto_rawDesc = []byte{
	...
	0xd4, 0x03, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52,
	...
	0x0c, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x49, 0x64, 0x73, 0x12, 0x42, 0x0a,
	0x0c, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x73, 0x18, 0x08, 0x20,
	0x03, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64,
	0x2e, 0x6d, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x2e, 0x53,
	0x54, 0x41, 0x47, 0x45, 0x52, 0x0b, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x53, 0x74, 0x61, 0x67, 0x65,
	0x73, 0x12, 0x36, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x70, 0x65, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x69, 0x73, 0x5f,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x61, 0x73, 0x63, 0x65, 0x6e, 0x64, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0d, 0x69, 0x73, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x41, 0x73, 0x63, 0x65, 0x6e,
	0x64, 0x12, 0x2c, 0x0a, 0x12, 0x77, 0x69, 0x74, 0x68, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69,
	0x6e, 0x65, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x77,
	0x69, 0x74, 0x68, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x12,
	0x45, 0x0a, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	...
	,
	...
	,
	...
	0x2e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75,
