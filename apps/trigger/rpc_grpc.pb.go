...
func (c *rPCClient) HandleEvent(ctx context.Context, in *Event, opts ...grpc.CallOption) (*Record, error) {
	...
	out := new(Record)
	err := c.cc.Invoke(ctx, RPC_HandleEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) DescribeRecord(ctx context.Context, in *DescribeRecordRequest, opts ...grpc.CallOption) (*Record, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Record)
	err := c.cc.Invoke(ctx, RPC_DescribeRecord_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RPC_HandleEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RPC_HandleEvent_FullMethodName,
	}
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "infraboard.mflow.trigger.RPC",
	...
	Metadata: "mflow/apps/trigger/pb/rpc.proto",
}
