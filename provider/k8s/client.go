...
import (
	...
	"github.com/infraboard/mflow/provider/k8s/admin"
	"github.com/infraboard/mflow/provider/k8s/config"
	"github.com/infraboard/mflow/provider/k8s/event"
	"github.com/infraboard/mflow/provider/k8s/network"
	"github.com/infraboard/mflow/provider/k8s/storage"
